			...
			<div class="body" id="contact">
				<div id="main">
					...
					<form action="" method="post" enctype="multipart/form-data" class="vcounter">
						...
						<textarea type="text" class ="register-input" name="description" id="description" required placeholder = "Complaint Description" ><?php echo $description ?></textarea><br>
						
						<input type="file" class ="register-input" name="image" id="image" value="<?php echo $image ?>" required placeholder = "Image">
						<br><br>
						<center><input type="submit" name="submit" id="submit" value="Edit Complaint" class="btn1"></center>
